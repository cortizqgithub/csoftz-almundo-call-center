...
public class IncomingCall {
    ...
    private String statusMsg; // To report the status of the processing.
     ...
     */
    @Builder
    private IncomingCall(String phoneNumber, IncomingCallStatus incomingCallStatus, Employee attendingEmployee, String statusMsg) {
